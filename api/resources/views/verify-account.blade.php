                            ...
                            <td class="content-cell">
                                <div class="f-fallback">
                                    ...
                                    <div class="text-body">
                                        <span>Xin chào,</span>
                                        <br /> 
                                        <span>Cảm ơn bạn đã chọn ứng dụng SkinDetective.</span>
                                        <span>Mã OTP để xác nhận tài khoản SkinDetective liên kết với email {{$email}} của bạn là:</span>
                                        <br /> 
                                        <span style="font-weight: bold;font-size: 22px;">{{$otp}}</span>
                                        <br /> 
                                        <span>Thời hạn xác nhận: 1 tiếng kể từ khi nhận được email.</span>
                                        <br /> 
