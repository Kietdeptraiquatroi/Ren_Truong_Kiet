...
class DiaDanh {
  ...
  List<DiaDanh> _diadanh = [
    DiaDanh(
        ...
        Image.asset('images\diadanhimg\1.ipg'),
    ...
    DiaDanh(
        ...
        Image.asset('images\diadanhimg\2.ipg'),
        'Thật Tuyệt',
        5,
        3000),
    DiaDanh(
        ...
        Image.asset('images\diadanhimg\3.ipg'),
    ...
    DiaDanh(
        ...
        Image.asset('images\diadanhimg\4.ipg'),
    ...
    DiaDanh(
        ...
        Image.asset('images\diadanhimg\5.ipg'),
...
class Khachsan {
  ...
  List<Khachsan> _khachsan = [
    Khachsan(
        'Nhà nghỉ Hoàng Thông (Hoang Thong Motel)',
        'Nhà Nghỉ',
        Image.asset('images\khachsanimg\1.ipg'),
        'Ben Dinh Thon Dong, An Vinh, Ly Son, Quang Ngai, An Vĩnh, Ly Son, Việt Nam '),
    Khachsan(
        'Mường Thanh Holiday Lý Sơn (Muong Thanh Holiday Ly Son)',
        'Khách Sạn',
        Image.asset('images\khachsanimg\2.ipg'),
        'Huyện đảo Lý Sơn, An Vĩnh, Ly Son, Việt Nam'),
    Khachsan(
        'Sun Hill Hotel',
        'Khách Sạn',
        Image.asset('images\khachsanimg\3.ipg'),
        'H60 Phan Chu Trinh,Ward 2, Vung Tau City, Phường 2, Vũng Tàu, Việt Nam'),
    Khachsan(
        'Hoa Mai Hotel',
        'Khách Sạn',
        Image.asset('images\khachsanimg\4.ipg'),
        'Đồng Hới, Đồng Hới (Quảng Bình), Việt Nam'),
    Khachsan(
        'Draha Halong Hotel',
        'Khách Sạn',
        Image.asset('images\khachsanimg\5.ipg'),
        'Lot 21-22-23, Phu Gia 4, Vinhomes Dragon Bay, Ha Long City, Quang Ninh Province, Cảng Hòn Gai, Ha Long, Việt Nam'),
  ];
}
